...
import { OrganizationEventMeetupsScreen } from "@/components/organization-dashboard/OrganizationEventMeetupsScreen";
...
export default function OrganizationEventMeetupsPage() {
  ...
  return (
    ...
    >
      <OrganizationEventMeetupsScreen eventId={eventId} />
    </OrganizationDashboardShell>
  );
}
