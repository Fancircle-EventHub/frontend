...
import { OrganizationEventNotificationsScreen } from "@/components/organization-dashboard/OrganizationEventNotificationsScreen";
...
export default function OrganizationEventNotificationsPage() {
  ...
  return (
    ...
    >
      <OrganizationEventNotificationsScreen eventId={eventId} />
    </OrganizationDashboardShell>
  );
}
