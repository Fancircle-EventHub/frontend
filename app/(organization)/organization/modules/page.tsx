...
export default function OrganizationModulesHubPage() {
  ...
  return (
    ...
    >
      <OrganizationEventHubPicker
        title="Modules"
        subtitle="Enable meetups, carpooling, gallery, and more for a specific event."
        actionLabel="Configure"
        hrefForEvent={(eventId) => `/organization/events/${eventId}/modules?standalone=1`}
      />
    </OrganizationDashboardShell>
  );
}
